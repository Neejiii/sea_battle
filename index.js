    ...
    SeeBattle.prototype = {
        ...
        startNewGame: function(){
            ...
            if(!this.userName || !this.pcName){
                alert('Неверно указанное имя');
                return;
            }

            this.startGameButton.innerHTML = 'Заново';
            this.pcInfo.innerHTML = this.pcName + ' (Противник)';
            this.userInfo.innerHTML = this.userName + ' (Вы)';
        ...
        updateToolbar: function(){
            ...
            if(this.isGameStopped()){
                if(this._userHits >= this._hitsForWin){
                    this.toolbar.innerHTML += ', Победа!';
                }else{
                    this.toolbar.innerHTML += ', Поражение';
                }
